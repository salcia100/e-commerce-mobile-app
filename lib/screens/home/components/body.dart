            ...
            Row(
              children: [
                ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> Login())).then((_) => checkLoginStatus()); 
                  },
                  child: Text("Login"),
                ),
                SizedBox(width: 8),
                ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> SignUp())).then((_) => checkLoginStatus());
                  },
                  child: Text("Sign Up"),
                ),
              ],
